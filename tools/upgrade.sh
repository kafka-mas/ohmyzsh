...
git remote -v | while read remote url extra; do
  ...
  git://github.com/robbyrussell/oh-my-zsh(|.git))
    ...
    git remote set-url "$remote" "https://github.com/kafka-mas/ohmyzsh.git" ;;
  https://github.com/robbyrussell/oh-my-zsh(|.git))
    git remote set-url "$remote" "https://github.com/kafka-mas/ohmyzsh.git" ;;
  git@github.com:robbyrussell/oh-my-zsh(|.git))
    git remote set-url "$remote" "git@github.com:kafka-mas/ohmyzsh.git" ;;
  https://github.com/kafka-mas/ohmyzsh(|.git)) ;;
  git@github.com:kafka-mas/ohmyzsh(|.git)) ;;
  *) continue ;;
  esac
